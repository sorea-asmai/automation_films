...
class NominationTest {
	...
	void getAwardCategoryObject() {
	    ...
	    assertEquals("getId()", 
                id, nominationObject.getId());
	    assertEquals("getAwardCategory()", 
               awardCate , nominationObject.getAwardCategory());
	    assertEquals("getMovie()", 
	    		movie, nominationObject.getMovie());
	    assertEquals("getPerson()", 
	    		person, nominationObject.getPerson());
	    assertEquals("getMovie()", 
	    		Boolean.FALSE, nominationObject.getIs_winning());
